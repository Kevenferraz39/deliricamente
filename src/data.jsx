/* ============================================================
  ...
  const AGENDA = [
    {
      id: "ag001",
      dia: "23", mes: "NOV", ano: "2024", date: "2024-11-23",
      time: "14:00", timeEnd: "22:00",
      title: "EPIFANIA — 2ª Edição",
      local: "Praça Pró Polo · Caieiras",
      endereco: "Praça Pró Polo, s/n, Caieiras — São Paulo",
      tipo: "Festival",
      description: "Segunda edição do festival independente do coletivo Deliricamente. Um dia inteiro de cultura na Praça Pró Polo: show, breaking, live paint, oficinas de fanzine, exposições e ativações pelo coletivo. Tudo gratuito, tudo nosso.\n\nProgramação: show Deliricamente, cinema na praça, pocket show, breaking, live paint, discotecagem, oficina de fanzine, palestras e trancistas.",
      imageUrl: "",
      videoUrl: "",
      active: true,
      featured: true,
    ...
    {
      id: "ag002",
      dia: "14", mes: "DEZ", ano: "2024", date: "2024-12-14",
      time: "19:00", timeEnd: "23:00",
      title: "Batalha de Rima #13",
      local: "Centro Cultural · Caieiras",
      endereco: "Centro Cultural de Caieiras, Av. Getúlio Vargas, Caieiras — SP",
      tipo: "Batalha",
      description: "Décima terceira edição da batalha mensal do coletivo. Inscrições abertas no Instagram. Premiação em livros e produtos do AGC para os classificados. Aberto para todos os estilos.",
      imageUrl: "",
      videoUrl: "",
      active: true,
      featured: false,
    ...
    {
      id: "ag003",
      dia: "11", mes: "JAN", ano: "2025", date: "2025-01-11",
      time: "20:00", timeEnd: "23:30",
      title: "Pocket Show — Deliricamente",
      local: "Bar do Lipe · Vila Mariana",
      endereco: "R. Domingos de Morais, 2564 — Vila Mariana, São Paulo — SP",
      tipo: "Show",
      description: "Show intimista do coletivo Deliricamente. Set inédito com faixas do próximo trabalho ao lado de clássicos. Capacidade limitada — garanta seu lugar.",
      imageUrl: "",
      videoUrl: "",
      active: true,
      featured: false,
    ...
    {
      id: "ag004",
      dia: "08", mes: "FEV", ano: "2025", date: "2025-02-08",
      time: "10:00", timeEnd: "17:00",
      title: "Oficina de Fanzine #07",
      local: "CEU Caieiras",
      endereco: "CEU Caieiras, R. José Bonifácio, 500 — Caieiras — SP",
      tipo: "Oficina",
      description: "Sétima edição da oficina aberta de criação de fanzines com material reciclado. Sem inscrição prévia, é só chegar com vontade. Material fornecido pelo coletivo. Para todas as idades.",
      imageUrl: "",
      videoUrl: "",
      active: true,
      featured: false,
